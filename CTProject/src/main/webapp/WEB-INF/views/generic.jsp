				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="${ctx }/" class="logo"><strong>Editorial</strong> by HTML5 UP</a>
									<ul class="icons">
						...
						<div class="inner">
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										<li><a href="${ctx }/java/">Homepage</a></li>
										<li><a href="${ctx }/java/generic">Generic</a></li>
										<li><a href="${ctx }/java/elements">Elements</a></li>
										<li>
